    ...
    <section className="w-full md:h-[75vh] border-b-2 border-solid border-dark dark:border-light flex md:flex-row flex-col items-center justify-center text-dark dark:text-light">
      <div className="w-full md:w-1/2 h-full border-r-2 border-solid border-dark dark:border-light flex justify-center">
        <Image
          ...
          alt="Kayla cartoon"
          className="w-4/5 xs:3/4 md:w-full h-full object-contain object-center"
          priority
          sizes="(max-width: 768px) 100vw, (max-width: 10180px) 50vw 50vw"
        />
      </div>
      <div className="w-full md:w-1/2 flex flex-col items-start justify-center px-5 xs:p-10 pb-10 lg:px-16">
        <h2 className="font-bold capitalize text-4xl text-center lg:text-left xs:text-5xl sxl:text-6xl">Dream Big, Work Hard, Achieve More!</h2>
