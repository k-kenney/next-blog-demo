    ...
    <footer className="mt-16 rounded-2xl bg-dark dark:bg-accentDark/90 m-2 sm:m-10 flex flex-col items-center text-light dark:text-dark">
      ...
      >
        <input
          ...
          className="w-full pl-2 sm:pl-0 bg-transparent text-dark dark:text-light  focus:border-dark focus:ring-0 border-0 border-b mr-2 pb-1"
        />
      ...
      <div className="w-full mt-16 md:mt-24 relative font-medium border-t border-solid border-light py-6 px-8 flex md:flex-row flex-col item-center justify-between">
        ...
        <div className="text-center">
          Made with &hearts; by{" "}
          <a href="https://kaylachristinekenney.com/" className="underline">
            Kayla
          </a>
        </div>
      </div>
